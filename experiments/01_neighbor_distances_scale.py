...
if USE_SOFTMAX:
    result_dir = os.getcwd() + '/../log_dir/result_data/exp01/scale_{id}_softmax_'.format(id=MODEL_ID)
else:
    result_dir = os.getcwd() + '/../log_dir/result_data/exp01/scale_{id}_'.format(id=MODEL_ID)
